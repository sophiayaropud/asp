...
namespace BuildingProject
{
	...
	public partial class BuildingsWindow : Window
    {
		...
		public BuildingsWindow()
		{
			...
			lvUsers.ItemsSource = _buildingManager.GetBuildings(UserManager.CurrentUser.Id);
		}
		...
		private void Search(object sender, RoutedEventArgs e)
		{
			...
			{
				lvUsers.ItemsSource = _buildingManager.GetBuildings(UserManager.CurrentUser.Id).Where(
